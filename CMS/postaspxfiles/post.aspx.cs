...
public partial class visitorsfeedback : System.Web.UI.Page
{
    ...
    private void SendContactUsFormDetail()
    {
        ...
        values.Add("Umm Al Emarat Park: ContactUs");
        ...
        string templateFile = "/email-templates/email_template_ContactUsAdmin.html";
        ...
        string customTableClassName = "contactform.contactus";
        ...
        if (customTable != null)
        {
            ...
            newCustomTableItem.SetValue("City", StripHTML(Request["city"]));
            newCustomTableItem.SetValue("Query", Request["question"]);
            newCustomTableItem.SetValue("Message", StripHTML(Request["message"]));
    ...
    {
        string templateFile = "/email-templates/email_template_ContactUs.html";
        string logopath = null;
        ...
        email = email.Replace("$MainHeading$", "ContactUs");
        ...
        EmailSender.SendEmail(PropertyReader.ReadProperty("fromEmail"), userEmail, PropertyReader.ReadProperty("ccEmail"), "Umm Al Emarate Park: Thank you for Contact to Us", email, "");
    }
