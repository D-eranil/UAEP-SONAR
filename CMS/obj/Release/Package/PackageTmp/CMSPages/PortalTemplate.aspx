...
<%=DocType%>
<% var temp = ""; string cultcode = CMS.Localization.LocalizationContext.CurrentCulture.CultureCode;%>
<% if (cultcode == "ar-AE") { temp = "rtl"; }%>
<html <%=XHtmlNameSpace%> <%=XmlNamespace%>  dir="<%=temp%>">
